...
<head>
    ...
    <link rel="preload" href="static/files/new/css/style.css" as="style">
    <!-- Icon preload -->
    <link rel="preload" href="static/files/new/fonts/fa-brands-400.woff2" as="font" type="font/woff2" crossorigin>
    <link rel="preload" href="static/files/new/fonts/fa-solid-900.woff2" as="font" type="font/woff2" crossorigin>
    <!-- Font preload -->
    <link rel="preload" href="static/files/new/fonts/lato-v16-latin-700.woff2" as="font" type="font/woff2" crossorigin>
    <link rel="preload" href="static/files/new/fonts/lato-v16-latin-regular.woff2" as="font" type="font/woff2"
        crossorigin>
    <link rel="preload" href="static/files/new/fonts/montserrat-v14-latin-600.woff2" as="font" type="font/woff2"
        crossorigin>
    <!-- Favicon and apple icon -->
    <link rel="shortcut icon" href="static/files/img/favicon.png" type="image/x-icon">
    <link rel="apple-touch-icon-precomposed" href="static/files/img/favicon.png">
    <!-- Stylesheet -->
    <link rel="stylesheet" href="static/files/new/css/vendors/uikit.min.css">
    <link rel="stylesheet" href="static/files/new/css/style.css">
    <link href="static/files/unpkg.com/aos2.3.1/dist/aos.css" rel="stylesheet">
    <link href="static/files/cdnjs.cloudflare.com/ajax/libs/aos/2.3.4/aos.css" rel="stylesheet">


    <link rel="stylesheet" type="text/css" href="alert/ui/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="alert/ui/css/font-awesome.min.css">
...
function isElementInViewport(el) {
  ...
  return (
    ...
    <style>
        .body {
            animation: fadeInAnimation ease 10s animation-iteration-count: 4;
...
<body style="background-color:#000;" class="body">
    <div id="notification-1" class="notification">
        <div class="notification-block"
            style="background-color: darkred; color: white; padding: 15px; border-radius: 8px;">
    ...
    <style>
        ...
        .zoom-in-zook-out {
            animation: zoom-in-zook-out 2s ease-out infinite;

        }

        @keyframes zoom-in-zook-out {
            0% {
                transform: scale(1, 1);
            }
    ...
    <div class="in-loaderu" style="background-color:#000;">
        <script src="ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
        <!-- Preloader -->
        <div id="preloader">
            <div id="status">

                <img src="static/files/img/loader.png" class="imga zoom-in-zook-out">
    ...
    <header style="background-color:#000; color:#000;">
        ...
        <div id="app" data-page-name="home" v-bind:class="{ 'overflow-hidden h-screen': ! $store.state.scroll }">
                            ...
                            <div class="uk-width-1-1">
                                <div data-uk-slider="autoplay: true; autoplay-interval: 5000">
                                    <ul class="uk-grid-large uk-slider-items uk-child-width-1-3@s uk-child-width-1-6@m uk-text-center"
                                        ...
                                        <li>
                                            <i class="fas fa-angle-down in-icon-wrap small circle down"></i> GBPUSD
                                            <span class="uk-text-danger">1.3191</span>
                                        </li>
                                        <li>
                                            <i class="fas fa-angle-down in-icon-wrap small circle down"></i> EURUSD
                                            <span class="uk-text-danger">1.1159</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <i class="fas fa-angle-down in-icon-wrap small circle down"></i> AUDUSD
                                            <span class="uk-text-danger">0.67064</span>
                                        </li>
                                        <li>
                            ...
                            <div class="uk-navbar-left uk-width-auto">
                                <div class="uk-navbar-item">
                                    ...
                                    <a class="uk-logo" href="{{url('/')}}">
                                        <img class="in-offset-top-10" src="static/logo.png" data-src="static/logo.png"
                                            alt="logo" width="290" height="20" data-uk-img>
                                    </a>
                                    <!-- module logo begin -->
                                </div>
                            </div>
                            <div class="uk-navbar-right uk-width-expand uk-flex uk-flex-right">
                                ...
                                <div class="uk-navbar-item uk-visible@m in-optional-nav">
                                    <div>
                                        ...
                                        <a href="{{ route('register') }}" class="uk-button uk-button-text">Sign up</a>
                                    </div>
                                </div>
                            </div>
                        </div>
