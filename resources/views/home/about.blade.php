...
<main style="background-color:#000; color:#dbdbdb;">
    <!-- section content begin -->
    <div class="uk-section" style="background-color:#000; color:#fff;">
        <div class="uk-container">
            <div class="uk-grid">
                <div class="uk-width-1-1">
                    <div class="uk-width-3-5@m">
                        <h1 class="uk-margin-small-bottom" style="color:#fff;">Putting our clients first <span
                                class="in-highlight">since 2016</span></h1>
                        <p class="uk-text-lead uk-text-muted uk-margin-remove-top" style="color:#dbdbdb;">For more than
                            5 years, we’ve been empowering clients by helping them take control of their financial
                            lives.</p>
                    </div>
                </div>
    ...
    <div class="uk-section in-offset-top-40 in-offset-bottom-20">
        <div class="uk-container">
            <div class="uk-grid">
                <div class="uk-width-1-1">
                    <div class="uk-card uk-card-default uk-border-rounded uk-background-center uk-background-contain uk-background-image@m" style="background-image: url(img/in-team-background-1.html);" data-uk-parallax="bgy: -100">
                        <div class="uk-card-body">
                            ...
                            <div class="uk-grid uk-child-width-1-2@m uk-margin-medium-top" data-uk-grid>
                                                                        <div class="uk-flex uk-flex-left">
                                        <div class="uk-margin-right">
                                            <img class="uk-align-center " src="static/files/wp-admin/uploads/professional_c23773ebb877670393769cd90496400c.jpg" alt="image-team" width="300" style="border-radius: 100%!important;">
                                        </div>
                                        <div>
                                            <p class="uk-text-small uk-text-muted uk-text-uppercase uk-margin-remove-bottom">CHIEF EXECUTIVE OFFICER </p>
                                            <h4 class="uk-margin-small-top">Luke desmaris</h4>
                                            <p>Luke has been a trader for 5 years and has built up many different strategies. </p>
                                            <div>
                                               <!-- <a class="uk-link-muted" href="https://www.facebook.com/lukefxsignals" target="_blank"><i class="fab fa-facebook-f uk-margin-small-right"></i></a><a class="uk-link-muted" href="https://instagram.com/des_fxtrades_?utm_medium=copy_link" target="_blank"><i class="fab fa-instagram uk-margin-small-right"></i></a><a class="uk-link-muted" href="https://t.me/lukefx_signals" target="_blank"><i class="fab fa-telegram uk-margin-small-right"></i></a><a class="uk-link-muted" href="https://wa.me/message/Z4SJRPY7DCTFI1" target="_blank"><i class="fab fa-whatsapp"></i></a>                                               </div>
                                        </div>
                                    </div>
                                                                        <div class="uk-flex uk-flex-left">
                                        <div class="uk-margin-right">
                                            <img class="uk-align-center " src="static/files/wp-admin/uploads/professional_42470b31dfe5f67bfddb6699f8a8f8b4.jpg" alt="image-team" width="300" style="border-radius: 100%!important;">
                                        </div>
                                        <div>
                                            <p class="uk-text-small uk-text-muted uk-text-uppercase uk-margin-remove-bottom">Assistant Manager </p>
                                            <h4 class="uk-margin-small-top">Jarvis Walsh </h4>
                                            <p>Jarvis is a proactive individual who is a master in the financial markets. </p>
                                            <div>
                                               <!-- <a class="uk-link-muted" href="https://www.facebook.com/javiswalsh" target="_blank"><i class="fab fa-facebook-f uk-margin-small-right"></i></a><a class="uk-link-muted" href="https://instagram.com/javis_walsh_fx?igshid=in4zl8clcchw" target="_blank"><i class="fab fa-instagram uk-margin-small-right"></i></a><a class="uk-link-muted" href="https://t.me/javis_walsh_fx" target="_blank"><i class="fab fa-telegram uk-margin-small-right"></i></a><a class="uk-link-muted" href="https://wa.me/message/CDGSW2WKCNOMO1" target="_blank"><i class="fab fa-whatsapp"></i></a>                                               </div>
                                        </div>
                                    </div>
                                                                        <div class="uk-flex uk-flex-left">
                                        <div class="uk-margin-right">
                                            <img class="uk-align-center " src="static/files/wp-admin/uploads/professional_8d73d1288cfbb6f7a82733b757a431e6.jpg" alt="image-team" width="300" style="border-radius: 100%!important;">
                                        </div>
                                        <div>
                                            <p class="uk-text-small uk-text-muted uk-text-uppercase uk-margin-remove-bottom">ASSISTANT MANAGER</p>
                                            <h4 class="uk-margin-small-top">Javier Hyson </h4>
                                            <p>Javier is a well skilled trader he provides weekly insights into current market .</p>
                                            <div>
                                               <!-- <a class="uk-link-muted" href="https://www.facebook.com/Javier.hyson" target="_blank"><i class="fab fa-facebook-f uk-margin-small-right"></i></a><a class="uk-link-muted" href="https://t.me/javierfxtrader" target="_blank"><i class="fab fa-telegram uk-margin-small-right"></i></a><a class="uk-link-muted" href="https://wa.me/message/OKG5QQSYS4NDK1" target="_blank"><i class="fab fa-whatsapp"></i></a>                                                </div>
                                        </div>
                                    </div>
                                                                </div>
                            <!--<div class="uk-grid uk-child-width-1-2@m uk-margin-medium-top" data-uk-grid>
                                <div class="uk-flex uk-flex-left">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <a class="uk-link-muted" href="#"><i class="fab fa-instagram uk-margin-small-right"></i></a>
                                            <a class="uk-link-muted" href="#"><i class="fab fa-linkedin-in uk-margin-small-right"></i></a>
                                            <a class="uk-link-muted" href="#"><i class="fab fa-telegram"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="uk-flex uk-flex-left">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <a class="uk-link-muted" href="#"><i class="fab fa-facebook-f uk-margin-small-right"></i></a>
                                            <a class="uk-link-muted" href="#"><i class="fab fa-twitter uk-margin-small-right"></i></a>
                                            <aclass="uk-link-muted" href="#"><i class="fab fa-linkedin-in"></i></a>
                                        </div></div>
                                </div>
                                <div class="uk-flex uk-flex-left">
                                    <div class="uk-margin-right">
                ...
                <div class="uk-width-3-4@m">
                    <div class="uk-grid uk-flex uk-flex-middle" data-uk-grid>
                        <div class="uk-width-1-2@m">
                            <h4 class="uk-text-muted" style="color:#fff;">Number speaks</h4>
                            <h1 class="uk-margin-medium-bottom" style="color:#dbdbdb;">We always ready<br>for a <span
                            ...
                            <div class="uk-margin-large" data-uk-grid>
                                <div class="uk-width-1-3@m">
                                    <h1 class="uk-text-primary uk-text-right@m">
                                        <span class="count" data-counter-end="6">0</span>
                                    </h1>
                                    <hr class="uk-divider-small uk-text-right@m">
                                </div>
                                <div class="uk-width-expand@m">
                                    <h4>Trading instruments</h4>
                                    <p>The foreign exchange market is the largest financial market in the world and has
                                        a variety of financial instruments to trade daily. This market has a daily
                                        average volume of $5 trillion. The best time to trade forex is when the
                                        volatility is high. Forex involves trading currencies by taking advantage of
                                        changes in the prices of currency pairs. Known as majors, the most traded
                                        currency pairs are the USD/JPY, GBP/USD, USD/CHF, and EUR/USD among others.
                                        These are the currencies of some of the world’s biggest economies.</p>
                                </div>
                            </div>
                            <!--<div class="uk-margin-large" data-uk-grid>
                                <div class="uk-width-1-3@m">
    ...
    <div class="uk-section">
        <div class="uk-container">
            <div class="uk-grid-match uk-grid-medium uk-child-width-1-2@s uk-child-width-1-3@m in-card-10" data-uk-grid>
                <div class="uk-width-1-1">
                    <h1 class="uk-margin-remove" style="color:#fff;">A <span class="in-highlight">relationship</span> on
                        your terms.</h1>
                    <p class="uk-text-lead uk-text-muted uk-margin-remove">Work with us the way you want.</p>
                    <p>Some believe you must choose between an online broker and a wealth management firm. At Glaxo
                        Capital Options,
                        you don’t need to compromise. Whether you invest on your own, with an advisor, or a little of
                        both — we can support you.</p>
                </div>
                <div>
                ...
                <div>
                    <div class="uk-card uk-card-default uk-card-body uk-border-rounded uk-light in-card-blue">
                        ...
                        <h4 class="uk-margin-top"><a href="#">Trading<i
    ...
    <div class="uk-section">
        <div class="uk-container">
            <div class="uk-grid">
                    ...
                    <div class="uk-grid uk-grid-small" data-uk-grid>
                        ...
                        <div class="uk-width-expand">
                            ...
                            <p>The best rated ASIC broker in the industry
                                ...
                                We are suggesting this broker so you can try their services on a demo account. Speak to
                                your financial advisor before opening a live account.</p>
                ...
                <div class="uk-width-1-3@m">
                    <h3 style="color:#fff;">Check out our Shares offer</h3>
                    <table class="uk-table uk-table-divider uk-table-striped uk-text-small uk-text-center">
                        ...
                        <tbody>
                            <tr>
                                <td style="color:#000;">Apple Inc CFD</td>
                            ...
                            <tr>
                                <td style="color:#000;">Facebook CFD</td>
                                <td style="color:#000;">10%</td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="uk-grid">
                ...
                <div class="uk-grid-divider uk-child-width-1-3@m uk-child-width-1-2@s" data-uk-grid>
                    <div>
                        ...
                        <h3 class="uk-margin-top" style="color:#fff;">Terms of Service</h3>
                    ...
                    <div><i class="fas fa-globe fa-lg in-icon-wrap primary-color"></i>
                        <h3 class="uk-margin-top" style="color:#fff;">Policies</h3>
                    ...
                    <div class="uk-visible@m">
                        ...
                        <h3 class="uk-margin-top" style="color:#fff;">Security</h3>
                    ...
                    <div class="uk-grid-small uk-child-width-1-2@s uk-child-width-1-1@m in-content-11" data-uk-grid>
                            ...
                            <a href="#" class="uk-card uk-card-small uk-card-default uk-card-body uk-border-rounded uk-display-block">
                                <div class="uk-grid" data-uk-grid>
                                    <div class="uk-width-auto@m uk-flex uk-flex-middle">
                                        <i class="fas fa-book fa-lg in-icon-wrap in-margin-remove-left@s uk-margin-left"></i>
                                    </div>
                                    <div class="uk-width-expand@m in-margin-small-top@s">
                                        <h4 class="uk-margin-small-bottom">Getting started with our product</h4>
                                        <img class="uk-border-pill uk-background-muted uk-float-left uk-margin-remove-adjacent uk-margin-small-right" src="img/in-team-7.png" width="40" height="40" alt="author-image">
                        ...
                        <div>
                            <a href="#" class="uk-card uk-card-small uk-card-default uk-card-body uk-border-rounded uk-display-block">
                                <div class="uk-grid" data-uk-grid>
                                    <div class="uk-width-auto@m uk-flex uk-flex-middle">
                                        <i class="fas fa-pen-nib fa-lg in-icon-wrap in-margin-remove-left@s uk-margin-left"></i>
                                    </div>
                                    <div class="uk-width-expand@m in-margin-small-top@s"><h4 class="uk-margin-small-bottom">Contracts and E-Signatures</h4><img class="uk-border-pill uk-background-muted uk-float-left uk-margin-remove-adjacent uk-margin-small-right" src="img/in-team-8.png" width="40" height="40" alt="author-image">
                        ...
                        <div><a href="#" class="uk-card uk-card-small uk-card-default uk-card-body uk-border-rounded uk-display-block">
                                <div class="uk-grid" data-uk-grid>
                                    <div class="uk-width-auto@m uk-flex uk-flex-middle">
                                        <i class="fas fa-file-invoice fa-lg in-icon-wrap in-margin-remove-left@s uk-margin-left"></i>
                                    </div>
                                    <div class="uk-width-expand@m in-margin-small-top@s">
                                        <h4 class="uk-margin-small-bottom">Invoicing and Getting paid</h4>
                                        <img class="uk-border-pill uk-background-muted uk-float-left uk-margin-remove-adjacent uk-margin-small-right" src="img/in-team-6.png" width="40" height="40" alt="author-image">
                        ...
                        <div>
                            <a href="#" class="uk-card uk-card-small uk-card-default uk-card-body uk-border-rounded uk-display-block">
                                <div class="uk-grid" data-uk-grid>
                                    <div class="uk-width-auto@m uk-flex uk-flex-middle">
                                        <i class="fas fa-users fa-lg in-icon-wrap in-margin-remove-left@s uk-margin-left"></i>
                                    </div>
                                    <div class="uk-width-expand@m in-margin-small-top@s">
                                        <h4 class="uk-margin-small-bottom">Project sources and Tracking</h4>
                                        <img class="uk-border-pill uk-background-muted uk-float-left uk-margin-remove-adjacent uk-margin-small-right" src="img/in-team-3.png" width="40" height="40" alt="author-image">
            ...
            <div class="uk-grid uk-flex uk-flex-center">
                <div class="uk-width-3-5@m">
                    <div class="uk-card uk-card-large uk-card-default in-card-paper">
                        <div class="uk-card-body">
                            <h2>Company Faq</h2>
                            <p>Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur consectetur adipiscing elit labore et dolore magna veritatis et quasi architecto beatae vitae.</p>
                            <p>Aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit laborum.</p>
                            ...
                            <ul class="in-faq-5" data-uk-accordion="collapsible: false">
                                ...
                                <li>
                                    ...
                                    <div class="uk-accordion-content">
                                        <ul class="uk-list uk-list-bullet">
                                            <li>Removing, distorting or altering any element of Company trademarks or branding</li>
                                            <li>Shortening, abbreviating, or using acronyms out of Company trademarks</li>
                                            <li>Combining your trademark or product name, visually or in text, with any Company trademark</li>
                                            <li>Indicating Company is endorsing or promoting your trademark or product</li>
                                            <li>Registering Company trademarks as or incorporated in social media account names, or aliases</li>
                                        </ul>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="uk-accordion-content">
                                        <p>Company trademarks include the following list. The absence of any Company trademark, product name, service name, or any other name from this list does not waive Company intellectual property rights.</p>
                                        <p>The Company logo and name is ® Registered in the Canada and The United States with registrations pending elsewhere. The ® Registered mark shall only be used in Canada and The United States until registrations are completed elsewhere.</p>
                                    </div>
                                </li>
                            </ul>
    ...
    <div class="uk-section">
        <div class="uk-container">
            <div class="uk-grid" data-uk-grid>
                <div class="uk-width-3-5@m">
                    <h1 class="uk-margin-small-bottom" style="color:#fff;"><span class="in-highlight">Knowledge</span>
                        is a wise investment</h1>
                    <p class="uk-text-lead uk-text-muted uk-margin-remove-top" style="color:#dbdbdb;">By combining
                        easy-to-understand information with actionable insights, Our company helps make the market seem
                        less daunting—and more approachable.</p>
                    <span class="uk-label uk-text-small uk-text-uppercase uk-border-pill">Learn</span>
                    <i class="fas fa-arrows-alt-h fa-sm uk-margin-small-leftuk-margin-small-right"></i>
                    <span class="uk-label uk-text-small uk-text-uppercase uk-border-pill">Understand</span>
                    <i class="fas fa-arrows-alt-h fa-sm uk-margin-small-leftuk-margin-small-right"></i><span
                        class="uk-label uk-text-small uk-text-uppercase uk-border-pill">Trade</span>
                </div>
                            ...
                            <tr>
                                <td class="uk-width-1-3@m">
                                    <div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
                                        ...
                                        <div class="uk-width-expand">
                                            <h3 style="color:#fff;">Beginner Course</h3>
                                        </div>
                                    </div>
                                </td>
                                <td>Learn the basic concepts of forex trading, what this market is all about, and why
                                    you should be a part of it.</td>
                            ...
                            <tr>
                                <td class="uk-width-1-3@m">
                                    <div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
                                        ...
                                        <div class="uk-width-expand">
                                            <h3 style="color:#fff;">Trading Tools</h3>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td class="uk-width-1-3@m">
                                    <div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
                                        ...
                                        <div class="uk-width-expand">
                                            <h3 style="color:#fff;">Stocks and CFDs</h3>
                                        </div>
                                    </div>
                                </td>
                    ...
                    <div class="uk-flex uk-flex-center uk-margin-medium-top uk-margin-bottom">
                        <div class="uk-width-3-4@m">
                            <div class="uk-grid-small uk-child-width-1-3@m uk-child-width-1-2@s" data-uk-grid>
                                <div>
                                    <a class="uk-button uk-button-default uk-border-rounded uk-width-expand" href="#"
                                        style="color:#dbdbdb;">Fast Academy</a>
                                </div>
                                <div>
                                    <a class="uk-button uk-button-default uk-border-rounded uk-width-expand" href="#"
                                        style="color:#dbdbdb;">Video Tutorials</a>
                                </div>
                                <div>
                                    <a class="uk-button uk-button-default uk-border-rounded uk-width-expand" href="#"
                                        style="color:#dbdbdb;">Course</a>
                                </div>
                                <div>
                                    <a class="uk-button uk-button-default uk-border-rounded uk-width-expand" href="#"
                                        style="color:#dbdbdb;">E-Books</a>
                                </div>
                                <div class="uk-visible@m">
                                    <a class="uk-button uk-button-default uk-border-rounded uk-width-expand" href="#"
                                        style="color:#dbdbdb;">Glossary</a>
                                </div>
                                <div class="uk-visible@m">
                                    <a class="uk-button uk-button-default uk-border-rounded uk-width-expand" href="#"
                                        style="color:#dbdbdb;">Trading Info</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="uk-grid">
                    <div class="uk-width-1-1">
                        <div class="uk-card uk-card-primary uk-box-shadow-small uk-border-rounded uk-background-cover" style="background-image: url(img/in-card-background-1.jpg);">
                            <div class="uk-card-body"><h2 class="uk-margin-remove-bottom">Free Demo Account</h2>
                                <p class="uk-margin-small-top">Practice Stocks andCFDs trading in a risk-free environment.</p>
                                <a class="uk-button uk-button-primary uk-border-rounded" href="#">Open an Account</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="uk-grid">
                <div class="uk-width-1-1 uk-flex uk-flex-center">
                    <div class="uk-width-3-4@m uk-margin-medium-bottom">
                        <p class="uk-text-lead" style="color:#fff;">We're constantly updating our roadmap to bring
                            transparency for our users and to get your feedback - please tell us what is important for
                            you!</p>
                        <!--<p>You can follow our progress here or follow us on Twitter &nbsp; <a href="#"><i class="fab fa-twitter"></i><span class="uk-text-lowercase">@wavecapital</span></a></p>-->
                    </div>
                </div>
                            ...
                            <div class="in-timeline-branch">
                                <div class="uk-flex">
                                    ...
                                    <div class="in-timeline-title uk-flex uk-flex-middle">
                                        <h4 class="uk-margin-remove-bottom" style="color:#dbdbdb;">Q4 2019</h4>
                                        <span
                        ...
                        <div>
                            <div class="in-timeline-branch">
                                <div class="uk-flex">
                                    ...
                                    <div class="in-timeline-title uk-flex uk-flex-middle">
                                        <h4 class="uk-margin-remove-bottom" style="color:#dbdbdb;">Q2 2020</h4>
                        ...
                        <div>
                            <div class="in-timeline-branch">
                                <div class="uk-flex">
                                    ...
                                    <div class="in-timeline-title uk-flex uk-flex-middle">
                                        <h4 class="uk-margin-remove-bottom" style="color:#dbdbdb;">Q3 2020</h4>
                                        <span
