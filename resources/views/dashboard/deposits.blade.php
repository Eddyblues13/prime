    ...
    <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <div class="btn-group mb-2">
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#depositModal">Make New Deposit</button>
                        </div>

                        <div class="table-responsive">
                            <table id="depositHistoryTable" class="display table dataTable table-striped table-bordered"
                                style="width:100%">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form style="padding:3px;" role="form" method="post"
                                ...
                                <input type="hidden" name="_token" value="pcuBxEFdCYa079Zep8CznP11JRHwk3HONdRzoqFo">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <center>
                                <p>
                                    <font color="red">Upload required documents to get verified.<br>Using the format
                                        below:</font>
                                    <img src="/verify.png" width="100%">
                                </p>
                            </center>
                            <form style="padding:3px;" role="form" method="post"
                                action="https://prmedge.com/dashboard/savevdocs" enctype="multipart/form-data">
                                <hr>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form style="padding:3px;" method="POST" action="{{ route('handle.deposit') }}">
                                @csrf
                                <!-- This generates the CSRF token automatically -->
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form style="padding:3px;" role="form" method="post"
                                ...
                                <input style="padding:5px;" class="form-control" placeholder="Charges (Fixed amount $)"
                                    type="text" name="charges_fixed" required><br />
                                <input style="padding:5px;" class="form-control" placeholder="Charges (Percentage %)"
                                    type="text" name="charges_percentage" required><br />
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form style="padding:3px;" role="form" method="post"
                                ...
                                <input style="padding:5px;" class="form-control" value="" type="text" disabled><br />
                                <input style="padding:5px;" class="form-control" placeholder="Enter amount to top up"
                                    type="text" name="amount" required><br />
                                <input type="hidden" name="_token" value="pcuBxEFdCYa079Zep8CznP11JRHwk3HONdRzoqFo">
            ...
            <div id="sendmailtooneuserModal" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <h4 class="modal-title" style="text-align:center;">This message will be sent to </h4>
                    </div>
        ...
        <div id="resetpswdModal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <h4 class="modal-title" style="text-align:center;">You are reseting password for .</strong></h4>
                        <p>Default password:</p>
                        <h3>#Tr@de#</h3><br>
                        <center> <a class="btn btn-primary" href="https://prmedge.com/dashboard/resetpswd/">Proceed</a>
                        </center>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        ...
        <div id="switchuserModal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <h4 class="modal-title" style="text-align:center;">You are about to login as .</strong></h4>
                        <center> <a class="btn btn-primary" href="https://prmedge.com/dashboard/switchuser/">Proceed</a>
                        </center>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        ...
        <div id="edituser" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <h4 class="modal-title" style="text-align:center;">Edit 's Details.</strong></h4>
                        ...
                        <form style="padding:3px;" role="form" method="post"
                            ...
                            <input style="padding:5px;" class="form-control" value="" type="text" name="ref_link"
                                required><br />
                            <input type="hidden" name="_token" value="pcuBxEFdCYa079Zep8CznP11JRHwk3HONdRzoqFo">
                            <input type="hidden" name="user_id" value="">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <h4 class="modal-title" style="text-align:center;">You are clearing account for to
                            $0.00</strong></h4>
                        <center> <a class="btn btn-primary" href="https://prmedge.com/dashboard/clearacct/">Proceed</a>
                        </center>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <form style="padding:3px;" role="form" method="post"
                            ...
                            <input style="padding:5px;" class="form-control" placeholder="Enter Plan name" type="text"
                                name="name" required><br />
                            <label>Plan price</label><br />
                            <input style="padding:5px;" class="form-control" placeholder="Enter Plan price" type="text"
                                name="price" required><br />
                            <label>Plan MIN. price</label><br />
                            <input style="padding:5px;" placeholder="Enter Plan minimum price" class="form-control"
                                type="text" name="min_price" required><br />
                            <label>Plan MAX. price</label><br />
                            <input style="padding:5px;" class="form-control" placeholder="Enter Plan maximum price"
                                type="text" name="max_price" required><br />
            ...
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <hr>
                        <p>
                            <font color="red">If Data Was Updated By an impostor or none admin, please change admin
                                login details Immediately.</font>
                        </p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
